		...
		<div class="container">
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay2.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay5.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay1.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay4.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay6.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay3.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay7.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay8.png" alt="">
						</li>
						<li>
							<img src="{{asset('/public/FrontEnd')}}/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
