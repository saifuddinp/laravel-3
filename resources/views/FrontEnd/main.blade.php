...
<div class="scrollbar">
			...
			<div class="item active">
				<div class="container">
					<div class="carousel-caption">
						...
						<a class="button2" href="{{url('/dashboard')}}">Shop Now </a>
					</div>
				</div>
			</div>
	...
	<div class="ads-grid">
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Our Top Products From Site
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('/public/FrontEnd')}}/images/d2.jpg" alt="">
						</div>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('/public/FrontEnd')}}/images/d1.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('/public/FrontEnd')}}/images/d4.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
							<h3>Tata Salt</h3>
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('/public/FrontEnd')}}/images/d5.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{asset('/public/FrontEnd')}}/images/d3.jpg" alt="">
						</div>
						<div class="col-xs-8 img-deal1">
				...
				<div class="wrapper">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/m1.jpg" alt="">
					...
					<div class="product-sec1 product-sec2">
						...
						<div class="col-xs-5 bg-right-nut">
							<img src="{{asset('/public/FrontEnd')}}/images/nut1.png" alt="">
						</div>
						<div class="clearfix"></div>
					</div>
					<!-- //second section (nuts special) -->
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk4.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk5.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk6.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
					...
					<div class="product-sec1">
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk7.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk8.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{asset('/public/FrontEnd')}}/images/mk9.jpg" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.html" class="link-product-add-cart">Quick View</a>
										</div>
	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="{{asset('/public/FrontEnd')}}/images/tab3.png" alt=" ">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
